 ...
 * new.js
 *
 * This script is meant to be used to create components and pages in a nextJS project.
 ...
 *
 * As this script makes use of process.cwd() it is requires to be started from
 * the next app's root directory such as
 *   node scripts/new.js
